...
public class ControladorUsuario {
	...
	@GetMapping("/") //Mostrare el form del login
	...
	@GetMapping("/registro") // Mostrare el formulario de registro
	public String formRegistro(Model modelo) {
		modelo.addAttribute("usuario", new Usuario());
		return "register.jsp";
	}
	
	@GetMapping("/logout") // Sera el cierre de sesion (logout)
	public String logOut(HttpSession sesion) {
		sesion.invalidate();
		return "redirect:/";
	}
	
	@PostMapping("/login")// procesare el logeo del usuario
	...
	@PostMapping("/register") // procesare la info del registro
